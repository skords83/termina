...
from app.api import admin_users, calendars, event_shares, events, ics_api, public_ics, sync_api
...
app.include_router(public_ics.router)  # kein /api-Prefix, kein Auth - siehe public_ics.py
